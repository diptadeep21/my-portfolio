      ...
      <div className='flex flex-col items-center justify-between w-full h-full'>
        ...
        <div className="flex items-center justify-between w-full">
          <Link
            href={demo || '#'}
            target='_blank'
            className="relative flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 decoration-clone cursor-pointer no-underline delay-[0.3s] group/play">
            <FaPlay />
            <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#0f0b24] text-white text-xs px-2 py-1 rounded whitespace-nowrap opacity-0 group-hover/play:opacity-100 transition-opacity duration-300 pointer-events-none border border-[#1a1443]">
              Live Demo
            </span>
          </Link>
          ...
          <Link
            href={code || '#'}
            target='_blank'
            className="relative flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 cursor-pointer no-underline delay-[0.3s] group-hover:translate-x-[-140px] group/code">
            <FaCode />
            <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#0f0b24] text-white text-xs px-2 py-1 rounded whitespace-nowrap opacity-0 group-hover/code:opacity-100 transition-opacity duration-300 pointer-events-none border border-[#1a1443]">
              GitHub Repo
            </span>
          </Link>
        </div>

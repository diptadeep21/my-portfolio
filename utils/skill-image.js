...
import dbms from '../app/assets/svg/skills/dbms.svg'
import os from '../app/assets/svg/skills/os.svg'
import oops from '../app/assets/svg/skills/oops.svg'
...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'sql':
      return sql;
    case 'data structures and algorithm':
      return dsa;
    case 'dbms':
      return dbms;
    case 'os':
